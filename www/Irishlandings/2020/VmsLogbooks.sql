...
where a.OperationDate between '1 jan 2015' and '1 jan 2019'
...
into #vms
from VMS..VMS_Position_Report a
   join FSS_Consolidated.hgerritsen.VMS_Calculated_Fields b
      on a.prt_id = b.prt_id
   join FSS_Consolidated.hgerritsen.VMS_Gear c
      on a.prt_id = c.prt_id
where a.date_time_logged between '1 jan 2015' and '1 jan 2019'
   and a.posn_long between -20 and 7
   and a.posn_lat between 36 and 65
   and b.best_speed between 
