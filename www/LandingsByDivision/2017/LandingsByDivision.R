...
setwd('F:\\StockBooks\\_Stock book 2017\\Plots\\LandingsByDivision')
...
unlink('IrishLandings2014-16.txt')
sink('IrishLandings2014-16.txt')
...
nep <- read.csv('\\\\galwayfs03\\fishdata\\StockBooks\\_Stock book 2017\\Plots\\nep_fus_landings.csv')
