...
setwd('l:\\StockBooks\\_Stockbook2018\\Plots\\LandingsByDivision')
...
#    barplot(t/1000,beside=T,las=3,col=pal[c(3,5,7)],ylab='Tonnes',legend=T,main=paste(S,'landings by Irish vessels'))
    par(mar=c(2.5,4,3,0))
    barplot(t/1000,beside=T,col=pal[c(3,5,7)],ylab='Tonnes',legend=T,main=paste(S,'landings by Irish vessels'), ylim=c(0,7000))
  dev.off()
