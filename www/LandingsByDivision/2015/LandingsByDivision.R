...
#setwd('F:\\StockBooks\\_Stockbook2016\\Plots\\LandingsByDivision')
setwd('H:/Stockbook/shiny/WIP/www/LandingsByDivision/2014')
...
"VIIj", "VIIk","VIIIa", "VIIIb", "VIIId", "VIIIe", "IXb", "Xb", "XIIa", 
"XIIb", "XIIc",'Other')

div_order1 <- c("2a", "2b", "4a", "4b", "4c","5b1", "6a", "6b", 
"7a", "7b", "7c", "7d", "7e", "7f", "7g", "7h", 
"7j", "7k","8a", "8b", "8d", "8e", "9b", "10b", "12a", 
"12b", "12c",'other')

data.frame(div_order,div_order1)


unlink('IrishLandings2011-13.txt')
sink('IrishLandings2011-13.txt')
...
nep <- read.csv('\\\\galwayfs03\\fishdata\\StockBooks\\_Stockbook2016\\Plots\\nep_fus_landings.csv')
nep$FU1 <- ifelse(nep$FU%in%c('15','16','17','19','22','2021'),as.character(nep$FU),'other')

t <- tapply(nep$X2013,nep$FU1,sum)
t <- rbind(t,tapply(nep$X2014,nep$FU1,sum))
t <- rbind(t,tapply(nep$X2015,nep$FU1,sum))
rownames(t) <- 2013:2015
